			...
			steps {
				container('container') {
					...
					dir ('eclipse.platform.swt') {
                        checkout([$class: 'GitSCM', branches: [[name: 'FETCH_HEAD']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'CloneOption', timeout: 120]], submoduleCfg: [], userRemoteConfigs: [[refspec: '${GERRIT_REFSPEC}', url: 'https://git.eclipse.org/r/platform/eclipse.platform.swt.git']]])
					}
